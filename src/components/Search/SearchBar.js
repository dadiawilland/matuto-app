...
const SearchBar = (props) => {
  ...
  const handleClose = (e) => {
    props.removeQueryParam(
      filterList.filter((filter) => filter.id === e)[0].key
    );
  ...
  return (
    <div style={styles().containerSearchBar}>
      ...
      />
      <SearchInput
        enterQueryParam={handleQueryParam}
        closeFilter={handleOnSelectFilter}
        filter={filter}
