...
const styles = (isOpen) => ({
  ...
  containerLevel1: {
    ...
    clipPath: isOpen
      ? 'polygon(0px 0px, 100% 0px, 85% 100%, 0% 100%)'
  ...
  containerLevel2: {
    ...
    clipPath: isOpen
      ? 'polygon(10% 0px, 100% 0px, 89% 100%, 0% 100%)'
      : 'polygon(17% 0px, 100% 0px, 80% 100%, 0% 100%)',
    transition: 'width 0.2s ease-out',
    position: 'absolute',
    zIndex: isOpen ? 99999 : 1
    // ':hover': {
  ...
  containerLevel3: {
    ...
    // clipPath: 'polygon(0 0, 100% 0, 70% 100%, 0% 100%)',
    clipPath: isOpen
      ? 'polygon(10% 0px, 98% 0px, 88% 100%, 0% 100%)'
      : 'polygon(20% 0px, 97% 0px, 79% 100%, 0% 100%)',
    position: 'absolute',
    transition: 'width 0.2s ease-out',
    zIndex: isOpen ? 99999 : 1
    // ':hover': {
  ...
  containerLevel4: {
    ...
    backgroundPosition: 'center',
    clipPath: isOpen
      ? 'polygon(14% 0%, 100% 0px, 100% 100%, 0% 100%)'
