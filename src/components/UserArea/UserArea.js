...
const Header = () => {
  ...
  return (
    <StyleRoot>
      <div
        style={isActive ? styles().containerIconActive : styles().containerIcon}
      >
        <img
          onClick={handleClick}
          key="img"
          style={isActive ? styles().imgIconActive : styles().imgIcon}
          src={icon}
          alt="Sign in logo"
        />
        {isActive ? (
          <div
            ...
            style={styles(isMessageActive).containerMessageIcon}
          >
            <img
              key="img"
              style={styles(isMessageActive).imgMessage}
              src={logoMessage}
              alt="Sign in logo"
            />
          </div>
        ...
        {isActive ? (
          <div
            ...
            style={styles(isWalletActive).containerWalletIcon}
          >
            <img
              key="img"
              style={styles(isWalletActive).imgWallet}
              src={logoWallet}
              alt="Sign in logo"
            />
          </div>
        ...
        {isActive && isMessageActive ? (
          <div style={styles().containerArea}>
            ...
            <div style={styles().containerMessages}>
              ...
              <div style={styles().containerChatBlack}>
                Hello Maria! How are you?
              </div>
              <div style={styles().containerChatPink}>
                Congrats on doing on good on your subjects. Don't hesitate to
                ask message me here if you have more questions.{' '}
              </div>
            </div>

            <div style={styles().containerTextArea}>Type here to reply</div>
          </div>
        ) : null}
