        ...
        return (
          <div>
            <NavLink style={styles().containerLink} to="/">
              <span style={styles().btnFont} key="help">
                Help
              </span>
            </NavLink>
            <NavLink style={styles().containerLink} to="/">
              <span style={styles().btnFont} key="contact">
                Contact
              </span>
            </NavLink>
          </div>
        ...
        return (
          <div>
            <NavLink style={styles().containerLink} to="/login">
              <span style={styles().btnFont} key="login">
                Login
              </span>
            </NavLink>
            <NavLink style={styles().containerLink} to="/register">
              <span style={styles().btnFont} key="register">
                Register
              </span>
            </NavLink>
          </div>
  ...
  return (
    <StyleRoot>
      <div style={styles().containerHeader}>
        ...
        <div style={styles().containerBtn}>{renderHeader(location)}</div>
      </div>
    </StyleRoot>
  );
};
